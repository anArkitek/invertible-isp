...
dng_path = sorted(glob.glob(os.path.join(os.path.dirname(os.path.abspath(__file__)), camera_name, 'DNG/*.dng')))
rgb_target_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), camera_name, 'RGB/')
raw_input_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), camera_name, 'RAW/')#'./' + camera_name + '/RAW/'
